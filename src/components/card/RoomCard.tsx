...
export const RoomCard = () => {
    return <div className="bg-neutral-primary-soft  text-white max-w-sm border  border-neutral-300 outline-1  outline-blue-800 rounded-base shadow-xs m-16 rounded-md">
    <a href="#">
        <Image width={0} height={1000} className=" rounded-t-base rounded-t-lg" src="/homeSlider/room1.avif" alt="" />
    </a>
    <div className="p-6 text-center bg-blue-800 border-b  rounded-b-lg ">
        ...
        <a href="#">
            <h5 className="mt-3 mb-6 text-2xl font-semibold tracking-tight text-heading">Streamlining your </h5>
        </a>
        <Button href="#" className="inline-flex items-center text-white bg-brand box-border border border-transparent hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
            Read more
