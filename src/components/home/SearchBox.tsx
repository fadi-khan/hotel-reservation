    ...
    return (
        <div className="rounded-lg flex items-center  flex-col lg:flex-row w-full bg-blue-800  p-5 select-none z-50">
            ...
            <div className={`${isOpen ? " z-50" : "z-30"} relative bg-white  rounded-lg  mb-2 lg:mb-0  `}>
                ...
                <div className={`z-50 absolute  mt-0.5 left-0  w-full transition-all duration-500 ease-in-out border border-blue-900 rounded   bg-white cursor-pointer ${isOpen ? "block" : "hidden"}`}>
                    {
            ...
            className=" hover:bg-blue-900 hover:text-white hover:border-white hover:border-2 bg-white cursor-pointer text-blue-900 font-bold border border-white  h-[48px] px-6  rounded-lg"/>
